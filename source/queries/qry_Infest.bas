dbMemo "SQL" ="SELECT tbl_Locations.Unit_Code, Year([Start_Date]) AS Visit_Year, tbl_Locations."
    ...
    "bl_Locations.Plot_ID) Is Not Null))\015\012AND tbl_Infestation.Exclude_Analysis "
    "<> 1\015\012ORDER BY tbl_Locations.Plot_ID, IIf(tbl_Locations.Unit_Code In (\"CA"
    "RE\",\"DINO\",\"GOSP\",\"ZION\"),[Utah_Species],IIf(tbl_Locations.Unit_Code=\"FO"
    "BU\",[WY_Species],[Co_Species]));\015\012"
dbMemo "Connect" =""
