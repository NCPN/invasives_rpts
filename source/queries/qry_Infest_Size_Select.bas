dbMemo "SQL" ="SELECT tbl_Locations.Unit_Code, Year([Start_Date]) AS Visit_Year, tbl_Locations."
    ...
    "de=\"FOBU\",[WY_Species],[Co_Species]))) Is Not Null))\015\012AND tbl_Infestatio"
    "n.Exclude_Analysis <> 1\015\012ORDER BY tbl_Locations.Plot_ID, IIf(tbl_Locations"
    ".Unit_Code In (\"CARE\",\"DINO\",\"GOSP\",\"ZION\"),[Utah_Species],IIf(tbl_Locat"
    "ions.Unit_Code=\"FOBU\",[WY_Species],[Co_Species]));\015\012"
dbMemo "Connect" =""
